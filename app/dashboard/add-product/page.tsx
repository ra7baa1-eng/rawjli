...
import { Package, DollarSign, Tag, Save } from 'lucide-react'
    ...
    <div className="p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">أدخل معلومات المنتج الجديد</p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="flex justify-center pt-6">
                <button
                  type="submit"
                  disabled={loading}
                  className="flex items-center px-8 py-3 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
                  {loading ? (
                    <>
